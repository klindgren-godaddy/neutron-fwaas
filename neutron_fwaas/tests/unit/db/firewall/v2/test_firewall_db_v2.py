...
class TestFirewallDBPluginV2(test_fwaas_plugin_v2.FirewallPluginV2TestCase):
    ...
    def test_get_policy_ordered_rules(self):
        with self.firewall_rule(name='alone', as_admin=True), \
                self.firewall_rule(name='fwr1', as_admin=True) as fwr1, \
                self.firewall_rule(name='fwr3', as_admin=True) as fwr3, \
                self.firewall_rule(name='fwr2', as_admin=True) as fwr2:
            fwrs = fwr1, fwr2, fwr3
            expected_ids = [fwr['firewall_rule']['id'] for fwr in fwrs]
            with self.firewall_policy(firewall_rules=expected_ids,
    ...
    def test_list_firewall_policies(self):
        with self.firewall_policy(name='fwp1', description='fwp',
                                  as_admin=True) as fwp1, \
                self.firewall_policy(name='fwp2', description='fwp',
                                     as_admin=True) as fwp2, \
                self.firewall_policy(name='fwp3', description='fwp',
                                     as_admin=True) as fwp3:
    ...
    def test_update_firewall_policy(self):
        ...
        with self.firewall_policy(shared=self.SHARED, firewall_rules=None,
                                  audited=self.AUDITED, as_admin=True) as fwp:
    ...
    def test_update_firewall_policy_replace_rules(self):
        ...
        with self.firewall_rule(name='fwr1', as_admin=True) as fwr1, \
                self.firewall_rule(name='fwr2', as_admin=True) as fwr2, \
                self.firewall_rule(name='fwr3', as_admin=True) as fwr3, \
                self.firewall_rule(name='fwr4', as_admin=True) as fwr4:
    ...
    def test_update_shared_firewall_policy_with_nonshared_rule(self):
        with self.firewall_rule(name='fwr1', shared=False,
                                as_admin=True) as fr:
            with self.firewall_policy(as_admin=True) as fwp:
    ...
    def test_update_firewall_policy_with_shared_and_shared_rules(self):
        with self.firewall_rule(name='fwr1', shared=self.SHARED,
                                as_admin=True) as fwr:
            fwr_ids = [fwr['firewall_rule']['id']]
            with self.firewall_policy(shared=False,
                                      firewall_rules=fwr_ids,
    ...
    def test_update_firewall_policy_assoc_with_other_tenant_firewall(self):
        with self.firewall_policy(shared=self.SHARED,
                                  tenant_id='tenant1', as_admin=True) as fwp:
            fwp_id = fwp['firewall_policy']['id']
    ...
    def test_update_firewall_policy_from_shared_to_unshared(self):
        with self.firewall_policy(shared=True, as_admin=True) as fwp:
    ...
    def test_update_from_shared_to_unshared_associated_as_ingress_fwp(self):
        with self.firewall_policy(shared=True, tenant_id='here',
                                  as_admin=True) as fwp:
            # update policy with public attr
            fwp_id = fwp['firewall_policy']['id']
    ...
    def test_update_default_fwg_policy(self):
        ...
        for ctx, as_admin in [(ctx_admin, True), (ctx_nonadmin, False)]:
            self._build_default_fwg(ctx=ctx, as_admin=as_admin)
            policies = self._list_req('firewall_policies')
            for p in policies:
                data = {'firewall_policy':
                        {'firewall_rules': []}}
                req = self.new_update_request('firewall_policies',
                                              data, p['id'], as_admin=True)
                res = req.get_response(self.ext_api)
                self.assertEqual(409, res.status_int)

    def test_delete_firewall_policy(self):
        ctx = self._get_admin_context()
        with self.firewall_policy(do_delete=False, as_admin=True) as fwp:
            fwp_id = fwp['firewall_policy']['id']
    ...
    def test_create_firewall_rule(self):
        ...
        with self.firewall_rule(as_admin=True) as firewall_rule:
            for k, v in attrs.items():
    ...
    def test_create_firewall_rule_icmp_with_port(self):
        ...
        attrs['protocol'] = 'icmp'
        attrs['expected_res_status'] = 400
        self._create_firewall_rule(self.fmt, as_admin=True, **attrs)
    ...
    def test_show_firewall_rule_with_fw_policy_not_associated(self):
        attrs = self._get_test_firewall_rule_attrs()
        with self.firewall_rule(as_admin=True) as fw_rule:
    ...
    def test_update_firewall_rule_with_port(self):
        with self.firewall_rule(source_port=None,
                                destination_port=None,
                                protocol=None, as_admin=True) as fwr:
    ...
    def test_update_firewall_rule_icmp_with_port(self):
        ...
        with self.firewall_rule(source_port=None,
                                destination_port=None,
                                protocol='icmp', as_admin=True) as fwr:
            data = {'firewall_rule': {'destination_port': 80}}
            req = self.new_update_request('firewall_rules', data,
                                          fwr['firewall_rule']['id'])
            res = req.get_response(self.ext_api)
    ...
    def test_update_firewall_rule_protocol_icmp(self):
        with self.firewall_rule(source_port=10000, as_admin=True) as fwr:
    ...
    def test_update_firewall_rule_with_ipv6_ipaddr(self):
        with self.firewall_rule(source_ip_address="1::10",
                                ...
                                ip_version=6, as_admin=True) as fwr_v6:
            data = {'firewall_rule': {
    ...
    def test_create_default_firewall_group_multiple_times_diff_tenants(self):
        ctx_admin = self._get_admin_context()
        fwg_admin = self._build_default_fwg(ctx=ctx_admin, as_admin=True)
    ...
    def test_create_firewall_group_with_fwp_on_different_tenant(self):
        ...
        fwg_name = "firewall1"
        description = "my_firewall1"
        with self.firewall_policy(shared=False, tenant_id='tenant2',
                                  as_admin=True) as fwp:
            fwp_id = fwp['firewall_policy']['id']
            ctx = self._get_nonadmin_context()
            self._create_firewall_group(fmt, fwg_name,
    ...
    def test_create_firewall_group_with_admin_and_fwp_is_shared(self):
        ...
        with self.firewall_policy(tenant_id="tenantX", as_admin=True) as fwp:
            fwp_id = fwp['firewall_policy']['id']
            ctx = self._get_admin_context()
    ...
    def test_list_firewall_groups(self):
        with self.firewall_policy(as_admin=True) as fwp:
            fwp_id = fwp['firewall_policy']['id']
            with self.firewall_group(
                    name='fwg1', tenant_id='tenant1',
                    ingress_firewall_policy_id=fwp_id,
                    description='fwg', as_admin=True) as fwg1, \
                    self.firewall_group(
                        name='fwg2', tenant_id='tenant2',
                        ingress_firewall_policy_id=fwp_id,
                        egress_firewall_policy_id=fwp_id,
                        description='fwg', as_admin=True) as fwg2, \
                    self.firewall_group(
                        name='fwg3', tenant_id='tenant3',
                        ingress_firewall_policy_id=fwp_id,
                        egress_firewall_policy_id=fwp_id,
                        description='fwg', as_admin=True) as fwg3:
    ...
    def test_existing_default_create_default_firewall_group(self):
        self._build_default_fwg(as_admin=True)
    ...
    def test_change_fwg_name_to_default(self):
        ...
        with self.firewall_group(context=nonadmin_ctx, as_admin=True) as fwg:
    ...
    def test_update_firewall_group_with_admin_and_fwp_different_tenant(self):
        ctx = self._get_admin_context()
        with self.firewall_policy(as_admin=True) as fwp1, \
                self.firewall_policy(tenant_id='tenant2',
                                     shared=False, as_admin=True) as fwp2, \
                self.firewall_group(
                    ingress_firewall_policy_id=fwp1['firewall_policy']['id'],
                    egress_firewall_policy_id=fwp1['firewall_policy']['id'],
                    context=ctx, as_admin=True) as fw:
    ...
    def test_update_firewall_group_fwp_not_found_on_different_tenant(self):
        with self.firewall_policy(name='fwp1', tenant_id='tenant1',
                                  shared=False, do_delete=False,
                                  as_admin=True) as fwp1, \
                self.firewall_group(
                    ingress_firewall_policy_id=fwp1['firewall_policy']['id'],
                    tenant_id='tenant1', do_delete=False,
                    as_admin=True) as fwg:
            fwg_id = fwg['firewall_group']['id']
            ...
            with self.firewall_policy(name='fwp2', tenant_id='tenant2',
                                      shared=False, as_admin=True) as fwp2:
                data = {
                    'firewall_group': {
    ...
    def test_delete_firewall_group_already_deleted(self):
        ctx = self._get_admin_context()
        with self.firewall_group(do_delete=False, context=ctx,
                                 as_admin=True) as fwg:
            fwg_id = fwg['firewall_group']['id']
    ...
    def test_insert_rule_in_policy_failures(self):
        with self.firewall_rule(name='fwr1', as_admin=True) as fr1:
            with self.firewall_policy(as_admin=True) as fwp:
                fwp_id = fwp['firewall_policy']['id']
    ...
    def test_insert_rule_for_previously_associated_rule(self):
        with self.firewall_rule(as_admin=True) as fwr:
            ...
            with self.firewall_policy(firewall_rules=fw_rule_ids,
                                      as_admin=True):
                with self.firewall_policy(name='firewall_policy2',
                                          as_admin=True) as fwp:
                    fwp_id = fwp['firewall_policy']['id']
    ...
    def test_insert_rule_for_previously_associated_rule_other_tenant(self):
        with self.firewall_rule(tenant_id='tenant-2', as_admin=True) as fwr:
            fwr_id = fwr['firewall_rule']['id']
            fw_rule_ids = [fwr_id]
    ...
    def test_insert_rule_for_prev_associated_ref_rule(self):
        with self.firewall_rule(name='fwr0', as_admin=True) as fwr0, \
                self.firewall_rule(name='fwr1', as_admin=True) as fwr1:
            fwr = [fwr0, fwr1]
            fwr0_id = fwr[0]['firewall_rule']['id']
            fwr1_id = fwr[1]['firewall_rule']['id']
            with self.firewall_policy(name='fwp0', as_admin=True) as fwp0, \
                    self.firewall_policy(name='fwp1',
                                         firewall_rules=[fwr1_id],
                                         as_admin=True) as fwp1:
                fwp = [fwp0, fwp1]
    ...
    def test_insert_rule_missing_rule_id(self):
        with self.firewall_rule(shared=False, as_admin=True):
            with self.firewall_policy(name='firewall_policy',
                                      as_admin=True) as fwp:
                fwp_id = fwp['firewall_policy']['id']
                insert_data = {}
                self._rule_action(
    ...
    def test_insert_rule_in_policy(self):
        ...
        with self.firewall_rule(name='fwr0', as_admin=True) as fwr0, \
                ...
                self.firewall_rule(name='fwr3', as_admin=True) as fwr3, \
                self.firewall_rule(name='fwr4', as_admin=True) as fwr4, \
                self.firewall_rule(name='fwr5', as_admin=True) as fwr5, \
                self.firewall_rule(name='fwr6', as_admin=True) as fwr6:
    ...
    def test_remove_rule_and_not_associated(self):
        with self.firewall_rule(name='fwr0', as_admin=True) as fwr:
            with self.firewall_policy(name='firewall_policy2',
                                      as_admin=True) as fwp:
                fwp_id = fwp['firewall_policy']['id']
                fwr_id = fwr['firewall_rule']['id']
    ...
    def test_show_firewall_rule_by_name(self):
        with self.firewall_rule(name='firewall_Rule1',
                                as_admin=True) as fw_rule:
    ...
    def test_show_firewall_group_by_name(self):
        with self.firewall_group(name='fireWall1', as_admin=True) as fw:
